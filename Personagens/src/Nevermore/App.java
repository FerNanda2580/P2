...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Então como ela poderia deixar que sua melhor amiga e colega de quarto " + enid.nome
                + " fosse acusada de envenenar " + xavier.nome + " injustamente, durante uma viagem com os seus amigos "
        ...
        if (first == 1) {
            ...
            if (second == 1) {
                System.out.println(wandinha.nome + " Foi expulsa após invadir a sala da diretora e " + enid.nome
                        + " foi julgada culpada.");
            }

            if (second == 2) {
                System.out.println(wandinha.nome + " decide então conversar com " + xavier.nome + " que confirma que "
                        + enid.nome + " estava com ele na hora do envenenamento, com um novo halibi, " + enid.nome
                        + " é inocentada");
            }
        }
        ...
        if (first == 2) {
            ...
            System.out.println("Ao vasculhar o quarto de " + tyler.nome
                    + "ela acha o veneno e entrega as autoridades, " + tyler.nome + " é julgado culpado.");
        }
